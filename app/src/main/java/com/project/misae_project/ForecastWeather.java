...
public class ForecastWeather extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            url = new URL("http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastSpaceData?ServiceKey="+serviceKey+"&base_date="+getTime+"&base_time=0200&nx="+xLoc+"&ny="+yLoc+"&pageNo=1&numOfRows=39&_type=json");
